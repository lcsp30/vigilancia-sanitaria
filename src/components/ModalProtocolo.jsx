    ...
    <Dialog.Root open={fechar} onOpenChange={setFechar}>
        ...
        <Dialog.Portal>
                ...
                <Dialog.Content className={styles.DialogContent}  onPointerDownOutside={(event) => event.preventDefault()}>
                    ...
                    Adicione os dados para gerar o Protocolo.
                </Dialog.Description>
                    <form className={styles.formModal} onSubmit={gerarRequerimento}>
                        <div className={styles.divInput}>
                            ...
                            <label htmlFor="r">Requerimento (SMS)</label>
                            </div>

                            <div className={styles.itensDoc}>
                                <input type="checkbox" name="ts" value="ts" id="" />
                                <label htmlFor="ts">Taxa de Saúde/VISA</label>
                            </div>

                            <div className={styles.itensDoc}>
                                <input type="checkbox" name="at" value="at" id="" />
                                <label htmlFor="at">Alvará Tributos</label>
                            </div>

                            <div className={styles.itensDoc}>
                                <input type="checkbox" name="pc" value="pc" id="" />
                                <label htmlFor="pc">Alvará Policia Civil</label>
                            </div>

                            <div className={styles.itensDoc}>
                                <input type="checkbox" name="lcb" value="lcb" id="" />
                                <label htmlFor="lcb">Licença Corpo de Bombeiro</label>
                            </div>

                            <div className={styles.itensDoc}>
                                <input type="checkbox" name="ls" value="ls" id="" />
                                <label htmlFor="ls">Licença da SEMA</label>
                            </div>

                            <div className={styles.itensDoc}>
                                <input type="checkbox" name="rg" value="rg" id="" />
                                <label htmlFor="rg">RG</label>
                            </div>

                            <div className={styles.itensDoc}>
                                <input type="checkbox" name="cpf" value="cpf" id="" />
                            ...
                            {tipoEstabelecimento == "cnpj" && 
                                ...
                                <div className={styles.divInput}>
                                     <div className={styles.itensDoc}>
                                <input type="checkbox" name="ce" value="ce" id="" />
                                <label htmlFor="ce">Constituição de Empresa</label>
                            </div>

                            <div className={styles.itensDoc}>
                                <input type="checkbox" name="vcn" value="vcn" id="" />
                                <label htmlFor="vcn">CNPJ</label>
                            </div>

                            <div className={styles.itensDoc}>
                                <input type="checkbox" name="in" value="in" id="" />
                                <label htmlFor="in">Insc. Estadual/ Municipal</label>
                            </div>

                            <div className={styles.itensDoc}>
                                <input type="checkbox" name="jc" value="jc" id="" />
                                <label htmlFor="jc">Junta Comercial</label>
                            </div>
                                </div>
                            }
                        ...
                        <div className={styles.divInput1}>
                            ...
                            <input type="date" name="validade" id="" />
                        </div>

                        <div className={styles.divInput1}>
                            <label htmlFor="n">Numero do Protocolo</label>
