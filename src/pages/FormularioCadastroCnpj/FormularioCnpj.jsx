            ...
            <div className={estilo.divPrincipal}>
                ...
                <div className={estilo.caixaCategoria}>
                    ...
                    <label htmlFor="categoria" >Categoria: </label>
                      <select name="categoria" id="" value={selecionado} onChange={valorSelect}>
                        ...
                        <option value="categoriaGeral">Categoria Geral</option>
                ...
                <div className={estilo.caixaInput}>
                    <div>
                        ...
                        <input name="razaoSocial" type="text" style={{width:"25vw"}} disabled={chave}/>
                    </div>
    
                    <div>
                        <label htmlFor="cnpj">CNPJ: </label>
                        <input name="cnpj" type="number" disabled={chave}/>
                    </div>
                ...
                <div className={estilo.caixaInput}>
                    <div>
                        ...
                        <input name="inscEstadual" type="text" disabled={chave}/>
                    </div>
    
                    <div>
                        <label htmlFor="inscMunicipal">Insc.Municipal: </label>
                        <input name="inscMunicipal" type="text" disabled={chave}/>
                    </div>
                ...
                <div className={estilo.caixaInput}>
                    ...
                    <div>
                            ...
                            <input name="naturezaJuridica" type="text" style={{width:"25vw"}} disabled={chave}/>
                    </div>
                </div>
